 ...
 */
public class TutorialSpringboard extends Prize {
    private Random rand;
    ...
    private TutorialSpringboardWithoutBlocks tutorialSpringboardWithoutBlocks;



    private float stateTime;

    public TutorialSpringboard(World world, int x, int y, int movement) {
        super(x, y, movement);

        tutorialSpringboardWithoutBlocks = new TutorialSpringboardWithoutBlocks(world,(int)Constants.getCarPostitionXRight(springboardAnimation.getKeyFrames()[0].getRegionWidth()),y,movement);
        defaultX = x;
        defaultY = y;
    ...
    public TutorialSpringboard(World world, int x, int y, int movement, boolean ifLeft) {
        super(x, y, movement);
        defaultX = x;
        defaultY = y;
...
//            position.x = Constants.getCarPostitionXRight(springboardAnimation.getKeyFrames()[0].getRegionWidth());
    ...
    public void draw(SpriteBatch batch) {
        ...
        tutorialSpringboardWithoutBlocks.draw(batch);
    ...
    public void update(float dt) {
        ...
        tutorialSpringboardWithoutBlocks.update(dt);
    }
    ...
    public void setPosition() {
        ...
        bounds.setPosition(position.x, position.y);
        body.setTransform(position.x, position.y, 0.0f);
        tutorialSpringboardWithoutBlocks.setPosition();
    }
    ...
    public static void updateCoins(ArrayList<TutorialSpringboard> busterses, Camera camera, float dt) {
...
//            if (!isBigCar)
            busterses.add(new TutorialSpringboard(world, 90, (int) camera.viewportHeight + 20, 10));
//            else
