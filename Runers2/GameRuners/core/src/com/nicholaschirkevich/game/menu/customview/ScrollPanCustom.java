...
public class ScrollPanCustom extends WidgetGroup {
     ...
     */
    public ScrollPanCustom(Actor widget) {
     ...
     * @param widget May be null.
     */
    public ScrollPanCustom(Actor widget, Skin skin) {
     ...
     * @param widget May be null.
     */
    public ScrollPanCustom(Actor widget, Skin skin, String styleName) {
     ...
     * @param widget May be null.
     */
    public ScrollPanCustom(Actor widget, ScrollPaneStyle style) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                getStage().setScrollFocus(ScrollPanCustom.this);
        ...
        if (!panning) {
            ...
            if (overscrollY && scrollY) {
                if (amountY < 0) {
                    ...
                    animating = true;
                   // if(overscrollListener!=null && amountY>100) overscrollListener.onOverscroll();
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (getStage() != null) getStage().calculateScissors(widgetAreaBounds, scissorBounds);
